...
void U_Find_AG(struct measure_type m, struct invert_type *r)
{
...

    {
        ...
        {
            double a_step = (r->mc_simplex_a_step > 0.0) ? r->mc_simplex_a_step : (a0 != 0.0 ? 0.05 * a0 : 0.00025);
            double g_step = (r->mc_simplex_g_step > 0.0) ? r->mc_simplex_g_step : (g0 != 0.0 ? 0.05 * g0 : 0.00025);
...
void U_Find_AB(struct measure_type m, struct invert_type *r)
{
...

    {
        ...
        {
            double a_step = (r->mc_simplex_a_step > 0.0) ? r->mc_simplex_a_step : (a0 != 0.0 ? 0.05 * a0 : 0.00025);
            double b_step = (r->mc_simplex_b_step > 0.0) ? r->mc_simplex_b_step : (b0 != 0.0 ? 0.05 * b0 : 0.00025);
            p[2][1] = scipy_bounded_initial_vertex(a0 + a_step, 0.0, 1.0);
