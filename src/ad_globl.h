...
void URU_and_UR1_Cone (int n, double n_slab, double mu, double **R,
		       double *URU, double *UR1);

void URU_and_URx_Cone (int n, double n_slab, double mu, double **R,
		       double *URU, double *URx);
