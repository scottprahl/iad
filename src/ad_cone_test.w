...
RT_Cone(N, &slab, slab.cos_angle, CONE, &bUR1, &bUT1, &bURU, &bUTU);
...
slab.cos_angle = 0.2;
slab.a = 0.0;
RT_Cone(N, &slab, slab.cos_angle, CONE, &aUR1, &aUT1, &aURU, &aUTU);
slab.a = 1.0;
RT_Cone(N, &slab, slab.cos_angle, CONE, &bUR1, &bUT1, &bURU, &bUTU);
...
RT_Cone(N, &slab, slab.cos_angle, CONE, &bUR1, &bUT1, &bURU, &bUTU);
PrintTestResults(5,1,&slab,slab.cos_angle, 0.0,0.0,0.0,0.0,bUR1,bUT1,bURU,bUTU);

slab.n_slab = 1.4;
RT_Cone(N, &slab, slab.cos_angle, CONE, &bUR1, &bUT1, &bURU, &bUTU);
PrintTestResults(5,2,&slab,slab.cos_angle, 0.0,0.0,0.0,0.0,bUR1,bUT1,bURU,bUTU);
