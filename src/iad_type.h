...
#define IAD_SEARCH_STALLED 40
#define IAD_MC_DID_NOT_CONVERGE 41 \

#define IAD_BEAM_TOO_BIG_FOR_SAMPLE_PORT 42
#define IAD_BEAM_TOO_BIG_FOR_ENTRANCE_PORT 43 \
