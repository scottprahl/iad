/* Autogenerated v3-16-1 from https://github.com/scottprahl/iad */
...
int main(int argc, char **argv)
{
    ...
    char command_line_options[] = "1:2:a:A:b:B:c:C:d:D:e:E:f:F:g:G:hH:i:L:M:n:N:o:p:q:r:R:s:S:t:T:u:vV:w:W:x:Xz";
