...
macOS it is usually \texttt{.dylib}; on Linux you may want to set
...
easy, while hard things remain possible (you can write your own code
...
For example, \iadprog{} requires that the \textit{total} reflection $M_R$
and \textit{total} transmission $M_T$ be measured.  You 
do not need to decide if the unscattered reflection or unscattered
