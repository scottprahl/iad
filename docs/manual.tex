...
Builds \iadprog{} and processes every \texttt{.rxt} file under
\texttt{tests/rxt} with Monte Carlo disabled.  This is a broad compatibility
test for the file parser, header interpretation, wavelength-row processing,
output-file creation, and the many historical data-file formats represented in
the test directory.  Because it disables Monte Carlo updates, it is slower than
\texttt{make test} but still deterministic.
