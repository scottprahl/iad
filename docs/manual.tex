...
\begin{description}
    ...
    \item[-M \#] maximum number of Monte Carlo lost-light iterations
    ...
    \item[-S \#] number of spheres used (\texttt{0}, \texttt{1}, or \texttt{2})
    ...
    \item[-X] dual beam configuration for \texttt{0} or \texttt{1} sphere only
...
holding the reduced scattering fixed.  If you also specify \texttt{-g}, then
...
to eliminate all the extra output from the \iadprog{} program.  This is not
