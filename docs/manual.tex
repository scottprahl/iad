...
Finally, if you want to run tests against the example datasets in
\texttt{tests/rxt}, then do
\begin{verbatim}
    prompt> make longtest
\end{verbatim}

The long tests are useful before a release, but they take longer because they
process many \texttt{.rxt} files.  During normal installation
\texttt{make veryshorttest} is the best smoke test.
