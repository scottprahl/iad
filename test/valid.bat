...
..\iad.exe -m -r 0.4 -t 0.1 -b 3
ECHO EXPECT  0.4000  0.4000  0.1000  0.1000  0.6221  3.9698  -0.6695
ECHO.

..\iad.exe -m -r 0.4 -t 0.1 -b 3 -n 1.5
ECHO EXPECT  0.4000  0.4000  0.1000  0.1000  0.4361  4.5201  -0.7630
ECHO.

..\iad.exe -m -r 0.4 -t 0.1 -b 3 -n 1.4 -N 1.5
...
..\iad.exe -m -r 0.4 -t 0.1              -S 2
ECHO EXPECT  0.4000  0.4000  0.1000  0.1000  0.2657  6.6591  0.0000
ECHO.

..\iad.exe -m -r 0.4 -t 0.1 -u 0.01      -S 2
ECHO EXPECT  0.4000  0.4000  0.1000  0.1000  0.3004  6.6607  -0.5473
ECHO.

..\iad.exe -m -r 0.2 -t 0.1 -u 0.049787  -S 2
ECHO EXPECT  0.2000  0.2000  0.1000  0.1000  0.7048  3.2091  -0.3982
ECHO.

ECHO.
ECHO ********* More Two Sphere tests ***********
..\iad.exe -m -r 0.4                     -S 2 -1 '200 13 13 0' -2 '200 13 13 0'
ECHO EXPECT  0.4000  0.4000  0.0000  0.0000  0.0482  1.0000  0.0000
ECHO.

..\iad.exe -m -r 0.4 -t 0.1              -S 2 -1 '200 13 13 0' -2 '200 13 13 0'
ECHO EXPECT  0.4000  0.4000  0.1000  0.1000  0.2657  6.6591  0.0000
ECHO.

..\iad.exe -m -r 0.4 -t 0.1 -u 0.01      -S 2 -1 '200 13 13 0' -2 '200 13 13 0'
ECHO EXPECT  0.4000  0.4000  0.1000  0.1000  0.3004  6.6607  -0.5473
ECHO.

..\iad.exe -m -r 0.2 -t 0.1 -u 0.049787  -S 2 -1 '200 13 13 0' -2 '200 13 13 0'
ECHO EXPECT  0.2000  0.2000  0.1000  0.1000  0.7048  3.2091  -0.3982
ECHO.
PAUSE